                ...
                <div class="col-lg-8">
                    <div class="single_project_item">
                        ...
                        <p>Tari tradisional adalah suatu tarian yang menggabungkan semua gerakan yang mengandung makna
                             tertentu. Pada tari tradisional mengandalkan ketepatan musik, keluwesan gerak, kekompakan 
                             gerakan, dan pengaturan komposisi. Pada gerak tari tradisional, biasanya pada setiap 
                             tarian mempunyai gerakan yang sama dan gerak tradisional tidak bisa diubah seperti tari 
                             modern. Walaupun tari tradisional mempunyai gerak yang sama, tetapi  pada tiap - tiap tarian 
                             berubah susunan gerakannya.</p>
                                    ...
                                    <div class="single_project_details">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <span>Desa Krasak,blok Sukamelang
                                                    RT.06 RW.02 kec.Jatibarang kab.Indramayu
                                                    (Toko Andika Jaya)
                                                </span>
                                            </div>
                                        </div>
                        ...
                        <p>Tari modern adalah merupakan tari yang didominasi oleh emosi atau rasa yang sebagaimana 
                            ciri kodrati emosi manusia yang memiliki desakan untuk ingin bebas, maka jenis tari ini
                             lebih mengarah untuk bebas dari tradisi. Bebas di sini adalah bebas untuk mengungkapkan
                              gerak yang tidak diharuskan oleh pola-pola yang sudah ada.</p>
                        <div class="project_time">
                            <div class="row">
                                <div class="col-lg-4 col-sm-4">
                                    <div class="single_project_details">
                        ...
                        <p>Tari K-POP kepanjangan dari Korean Pop ('Musik Pop Korea') adalah tari yang mengcover atau meniru
                            gerakan dance atau tarian dari seorang Idol Korea. Biasanya tari ini lebih sering dilakukan oleh
                            penggemar K-POP karena mereka akan bergaya ala Idol Korea favorite mereka untuk mengcover atau meniru gerakan
                            dance atau koreografi dari lagu-lagu Idol Korea tersebut.</p>
                        <div class="project_time">
                            <div class="row">
                                <div class="col-lg-4 col-sm-4">
                                    <div class="single_project_details">
                        ...
                        oleh masyarakat Afro-Amerika dan Latin-Amerika. Hip Hop merupakan perpaduan yang sangat dinamis antara 
                        elemen-elemen yang terdiri dari MCing (lebih dikenal rapping), DJing,Breakdance, dan Graffiti.</p>
                        <div class="project_time">
                            <div class="row">
                                <div class="col-lg-4 col-sm-4">
                                    <div class="single_project_details">
