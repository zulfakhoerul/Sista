            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-8">
                    <div class="about_us_text text-center">
                        ...
                        <h2>Angelo Dance School</h2>
                        <p>Merupakan sanggar tari yang berdiri sekitar satu tahun yang lalu. Sanggar tari Angelo Dance School 
                        ini berada di Desa Krasak blok sukamelang RT.06 RW.02 Kecamatan Jatibarang Kabupaten Indramayu (Toko Andika Jaya)
                        Jawa Barat. Pada sanggar tari ini terdapat beberapa jenis tari diantaranya yaitu Tari Tradisional, Tari Modern, 
                        Tari K-POP, dan Tari Hiphop. Disini juga bisa menyewakan kostum dengan berbagai jenis tari termasuk aksesoris nya juga.
                        Selain itu disini juga menyediakan sewa jasa make up untuk graduation atau pun pre-wedding dan juga bisa menyewa
                        jasa penari untuk acara wedding atau pun yang lainnya. Angelo Dance School ini sudah mengikuti berbagai lomba tari 
                        yang ada didaerah Indramayu maupun Cirebon dan sudah memenangkan beragam lomba yang diikuti.</p>
                    ...
                    <div class="intro_video_iner text-center">
                        ...
                        <div class="intro_video_icon">
                            <a id="play-video_1" class="video-play-button popup-youtube"
                                href="https://www.youtube.com/watch?v=OLJJ4SlwJoA">
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-6 col-lg-6">
                    <div class="review_img">
                        <img src="img/review_bg.jpeg" alt="">
                    </div>
                </div>
                <div class="col-md-6 col-lg-5">
                    <div class="review_slider owl-carousel">
                        <div class="review_part_text">
                            <h2>Chandra De Angelo</h2>
                            <p>Pelatih sanggar tari Angelo Dance School ini merupakan lulusan tahun 2018 dari Institute
                                Seni Bandung (ISBI) yang lahir pada tanggal 24 September 1996. Selain melatih dance di sanggar nya
                                sendiri, dia juga bekerja sebagai guru seni di suatu Sekolah Menengah Kejuruan di daerah Indramayu.
                            </p>
                            <h3> <span></span> </h3>
                        </div>
                      <!--  <div class="review_part_text">
                ...
                <div class="col-lg-12">
                    <div class="copyright_part_text text-center">
                        <p class="footer-text m-0">Copyright © 2019 All rights reserved <span class="px-2">|</span> This
                            ...
                            <a href="http://colorlib.com">Kelompok 6</a></p>
                    </div>
                </div>
            </div>
        </div>
